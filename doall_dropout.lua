...
-- training:
cmd:option('-save', 'results_dropout_sub3', 'subdirectory to save/log experiments in')
...
-- end of addition
cmd:option('-prompt', "", 'Name of the prompt/dataset')
cmd:option('-numscores', 4, 'Number of score points in the prompt/dataset')
--
cmd:text()
